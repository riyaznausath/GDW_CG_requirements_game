...
#include "PostProcessing/CoolColorCorrectionEffect.h"
#include "PostProcessing/WarmColorCorrectionEffect.h"
#include "PostProcessing/GrayscaleColorCorrectionEffect.h"
...
#include "PostProcessing/Toonshading.h"
...
void PostProcessingLayer::OnAppLoad(const nlohmann::json& config)
{
	...
	_effects.push_back(std::make_shared<WarmColorCorrectionEffect>());
	_effects.push_back(std::make_shared<GrayscaleColorCorrectionEffect>());
	...
	//_effects.push_back(std::make_shared<Toonshading>());

	GetEffect<OutlineEffect>()->Enabled = false;
	GetEffect<ColorCorrectionEffect>()->Enabled = false;
	GetEffect<WarmColorCorrectionEffect>()->Enabled = false;
	GetEffect<GrayscaleColorCorrectionEffect>()->Enabled = false;
