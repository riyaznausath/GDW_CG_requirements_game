...
RenderLayer::RenderLayer() :
	...
	_renderFlags(RenderFlags::EnableLights | RenderFlags::EnableShadows | RenderFlags::EnableAmbient),
...
void RenderLayer::OnPreRender()
{
	...
	else if (_renderFlags == RenderFlags::EnableWarmCorrection)
	{
...
void RenderLayer::_AccumulateLighting()
{
	...
	if (*_renderFlags & *RenderFlags::EnableLights) {
	...
	if (*_renderFlags & *RenderFlags::EnableShadows) {
