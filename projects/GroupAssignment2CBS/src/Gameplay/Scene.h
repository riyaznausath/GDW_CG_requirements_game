...
namespace Gameplay {
	...
	public:
		...
		bool                       IsPlaying;
		bool                       LightCheck; //check if light is on or not
		bool                       AmbientLightCheck; //check if light is on or not
		bool                       SpecularLightCheck; //check if light is on or not
		bool                       customCheck; //check if light is on or not
		bool IsDestroyed;
		...
		std::vector<GameObject::Sptr> EnemySpawnerObjects;
		std::vector<std::string> EnemySpawnerNames;
	...
	protected:
		...
		Texture3D::Sptr               _colorWarmCorrection;
